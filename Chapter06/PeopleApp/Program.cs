...
{
    WriteLine(format: " {0}'s children #{1} is named \"{2}\".",
...
// Harry_Shout is the method and Shout is the delegate
...
OutputPeopleNames(people,
    "After sorting using PersonCompareer's IComparer implementation:");
