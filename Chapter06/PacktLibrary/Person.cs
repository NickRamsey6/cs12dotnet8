...
public class Person : IComparable<Person?>
{
    ...
    {
        // these check for nulls for either Person
        // If null were passed, the exception is thrown
    ...
    // Instance method to output the spouses of a person if they are married
    ...
    /// <excpetion cref="ArgumentException">If p1 or p2 are null.</excpetion>
    ...
    public int CompareTo(Person? other)
    {
        ...
        {
            // If this and other are not null compare their names
            if ((Name is not null) && (other.Name is not null))
            {
                // If both Name values are not null, then use string implementation of CompareTo
            ...
            {
                position = 0; // this and other are at the same psoition
            }
        }
