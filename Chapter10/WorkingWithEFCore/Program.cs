...
WriteLine("About to delete all products whse name starts with Bob.");
...
var resultUpdateBetter = IncreaseProductPriceBetter(productNameStartsWith: "Bob", amount: 20M);
